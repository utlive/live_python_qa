...
savemat('data/live_vqa_' + args.wavelet + '_vifs.mat', {'vifs': sim_spat_alls})
...
savemat('data/live_vqa_' + args.wavelet + '_vifs.mat', {'vifs': sim_spat_alls, 'pcc': pcc, 'srocc': srocc, 'rmse': rmse})
